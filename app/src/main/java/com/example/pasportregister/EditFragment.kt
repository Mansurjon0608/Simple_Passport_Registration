...
import com.example.pasportregister.databinding.FragmentAddBinding.bind
import com.example.pasportregister.databinding.FragmentAddBinding.inflate
import com.example.pasportregister.databinding.FragmentEditBinding
...
class EditFragment : Fragment() {
    ...
    binding = inflate(LayoutInflater.from(context))
        ...
        binding.btnBack.setOnClickListener {if (binding.editName.text.toString() != "" && binding.editSurname.text.toString() != "") {
        ...
        binding.btnSave.setOnClickListener {
            ...
            if (fuqaro.name != "" && fuqaro.lastName != "" && absolutePath != "" && binding.spinnerJinsi.selectedItemPosition!=0 && binding.spinnerViloyatlar.selectedItemPosition!=0) {
        ...
        fuqaro = arguments?.getSerializable("fuqaroKey") as Fuqaro

        binding.editName.setText(fuqaro.name)
        binding.editSurname.setText(fuqaro.lastName)
        binding.editOtaIsmi.setText(fuqaro.otasiningIsmi)
        binding.editShahar.setText(fuqaro.city)
        binding.editPassportMuddati.setText(fuqaro.passportDedline)
        binding.editPasportOlganVaqti.setText(fuqaro.passportOlganVaqti)
        binding.editUyManzili.setText(fuqaro.uyManzili)
        absolutePath = fuqaro.imagePath!!
        binding.image.setImageURI(Uri.parse(fuqaro.imagePath))
        binding.spinnerJinsi.setSelection(fuqaro.jinsi!!)
        binding.spinnerViloyatlar.setSelection(fuqaro.viloyat!!)
